...
<section id="basic-vertical-layouts">
    <div class="row match-height">
        <div class="col-md-12 col-24">
            ...
            @endif
            <form class="form form-horizontal" method="POST" action="{{ route('product_variant.update', ['product' => $productVariant->product->id, 'productVariant' => $productVariant->id]) }}" enctype="multipart/form-data">
                <div class="card">
