...
<section id="basic-vertical-layouts">
    <div class="row match-height">
        <div class="col-md-12 col-24">
            <form class="form form-horizontal" method="POST" action="{{ route('announcement.store') }}">
                <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="start-from-vertical" class="form-control @error('start_from') is-invalid @enderror"
                                                name="start_from" value="{{ old('start_from') ?? today()->format('Y-m-d') }}">
                                            @error('start_from')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="valid-until-vertical" class="form-control @error('valid_until') is-invalid @enderror"
                                                name="valid_until" value="{{ old('valid_until') ?? today()->addDays(1)->format('Y-m-d') }}">
                                            @error('valid_until')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                    ...
                                    <div class="col-12">
                                        <div class='form-check form-switch'>
                                            <div class="checkbox">
                                                <input checked {{ old('is_private') == 'on' ? 'checked' : '' }} type="checkbox" id="checkbox3" class='form-check-input' name="is_private">
