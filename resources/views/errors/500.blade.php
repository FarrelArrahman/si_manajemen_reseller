        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <div class="text-center">
                    ...
                    <h1 class="fs-1 error-title">Error 500</h1>
                    <p class='fs-5 text-gray-600'>Terjadi kesalahan pada server. Harap coba lagi.
                    <br> Jika error terus berlanjut, hubungi <a target="_blank" href="http://wa.me/{{ substr_replace(\App\Models\Configuration::configName('customer_service_phone_number'), '62', 0, 1) }}">Customer Service</a>.</p>
